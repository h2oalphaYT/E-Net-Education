...
<title>Delete time table here</title>
<link rel="icon" type="images/x-icon" href="images/logo.png">
<link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="css/deletett.css">
...
<body>
  ...
  <div class="container-fluid">
	...
	<form action="deletett" method="post">
	...
	<div class="input_field">
		<label>Date</label>
		<input type="date" name="edate" value="<%= edate%>" readonly>
	</div>
	<div class="input_field">
		<label>Time</label>
		<input type="time" name="stime" value="<%= stime%>" readonly required>
	</div>
	<div class="input_field">
		<label>duration</label>
		<input type="text" name="tdue" value="<%= tdue%>" readonly>
	</div>
	
	<div class="input_field">
		<input class="btn" type="submit" value="delete time table">
	</div>	
